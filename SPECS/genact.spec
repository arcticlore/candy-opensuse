...
%description
Генератор безумной активности — притворись хакером
...
%install
install -Dpm0755 target/release/genact %{buildroot}%{_bindir}/genact
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 1.5.1-1
