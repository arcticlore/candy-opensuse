...
Version:        0.1.1
Release:        1%{?dist}
Summary:        GitHub contribution visualization tool inspired by neofetch
...
%description
GitHub contribution visualization tool inspired by neofetch
...
%prep
%autosetup -N -a1 -n gitfetch-0.1.1
mkdir -p .cargo
...
%install
install -Dpm0755 target/release/gitfetch %{buildroot}%{_bindir}/gitfetch
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 0.1.1-1
