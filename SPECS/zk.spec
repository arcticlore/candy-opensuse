...
%description
Zettelkasten-заметки в терминале
...
go build -trimpath -ldflags '-s -w' -o zk .

%install
install -Dpm0755 zk %{buildroot}%{_bindir}/zk
...
%changelog
* Fri Sep 18 2026 candy-bot <candy@localhost> - 0.15.6-1
