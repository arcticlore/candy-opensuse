...
%install
install -Dpm0755 target/release/wallust %{buildroot}%{_bindir}/wallust
install -Dpm0755 target/release/salsort %{buildroot}%{_bindir}/salsort
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 4.1.0~alpha-1
