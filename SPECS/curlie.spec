...
go build -trimpath -ldflags '-s -w' -o curlie .

%install
install -Dpm0755 curlie %{buildroot}%{_bindir}/curlie
...
%changelog
* Fri Sep 18 2026 candy-bot <candy@localhost> - 1.8.2-1
