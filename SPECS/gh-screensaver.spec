...
go build -trimpath -ldflags '-s -w' -o gh-screensaver .

%install
install -Dpm0755 gh-screensaver %{buildroot}%{_bindir}/gh-screensaver
...
%changelog
* Wed Sep 16 2026 candy-bot <candy@localhost> - 2.0.1-1
