...
Version:        6.4.0
Release:        1%{?dist}
Summary:        System information fetcher with an emphasis on performance
...
%description
System information fetcher with an emphasis on performance
...
%prep
%autosetup -N -a1 -n macchina-6.4.0
mkdir -p .cargo
...
%install
install -Dpm0755 target/release/macchina %{buildroot}%{_bindir}/macchina
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 6.4.0-1
