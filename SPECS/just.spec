...
Version:        1.58.0
Release:        1%{?dist}
Summary:        Современный command runner (Make без боли)
...
%description
Современный command runner (Make без боли)
...
%install
install -Dpm0755 target/release/just %{buildroot}%{_bindir}/just
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 1.58.0-1
