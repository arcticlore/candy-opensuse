...
Version:        1.3.4
Release:        1%{?dist}
Summary:        Быстрый csv-просмотрщик с поддержкой CJK/эмодзи
...
%description
Быстрый csv-просмотрщик с поддержкой CJK/эмодзи
...
%install
install -Dpm0755 target/release/csview %{buildroot}%{_bindir}/csview
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 1.3.4-1
