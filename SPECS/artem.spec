...
Version:        3.0.0
Release:        1%{?dist}
Summary:        Convert images from multiple formats to ASCII art
...
%description
Convert images from multiple formats to ASCII art
...
%install
install -Dpm0755 target/release/artem %{buildroot}%{_bindir}/artem
