...
Version:        0.28.1
Release:        1%{?dist}
Summary:        TUI-интерфейс для git ( staging, branches, interactive rebase )
...
%install
install -Dpm0755 target/release/gitui %{buildroot}%{_bindir}/gitui
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 0.28.1-1
