...
Version:        2.24.0
Release:        1%{?dist}
Summary:        Интерактивные шпаргалки ( cheatsheets ) для командной строки
...
%description
Интерактивные шпаргалки ( cheatsheets ) для командной строки
...
%install
install -Dpm0755 target/release/navi %{buildroot}%{_bindir}/navi
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 2.24.0-1
