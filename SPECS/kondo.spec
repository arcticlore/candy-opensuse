...
Version:        0.9
Release:        1%{?dist}
Summary:        Чистка build-артефактов проектов (node_modules/target)
...
%description
Чистка build-артефактов проектов (node_modules/target)
...
%changelog
* Fri Sep 18 2026 candy-bot <candy@localhost> - 0.9-1
