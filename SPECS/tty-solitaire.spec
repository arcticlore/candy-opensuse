...
Version:        1.4.1
Release:        1%{?dist}
Summary:        Пасьянс в терминале на ncurses
...
%description
Пасьянс в терминале на ncurses
...
%prep
%autosetup -p1 -n tty-solitaire-1.4.1
...
%changelog
* Fri Sep 18 2026 candy-bot <candy@localhost> - 1.4.1-1
