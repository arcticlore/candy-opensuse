...
Version:        0.2.0
Release:        1%{?dist}
Summary:        Tiny system info fetch utility
...
%prep
%autosetup -N -a1 -n bunnyfetch-0.2.0
...
go build -trimpath -ldflags '-s -w' -o bunnyfetch .

%install
install -Dpm0755 bunnyfetch %{buildroot}%{_bindir}/bunnyfetch
...
%changelog
* Fri Sep 18 2026 candy-bot <candy@localhost> - 0.2.0-1
