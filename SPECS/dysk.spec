...
%description
df для людей: диски человекочитаемо
...
%install
install -Dpm0755 target/release/dysk %{buildroot}%{_bindir}/dysk
...
%changelog
* Sat Sep 19 2026 candy-bot <candy@localhost> - 3.7.0-1
